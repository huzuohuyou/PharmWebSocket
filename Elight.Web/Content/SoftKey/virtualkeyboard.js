...
var VirtualKeyboard = new function () {
    ...
    var H = function (i) {
        if (U.attachedInput) {
            ...
            if (U.attachedInput.contentWindow) U.attachedInput.contentWindow.document.body.dir = X;
            else U.attachedInput.dir = X
        }
    };
    var j = function () {
    ...
    var L = function (i) {
        var e = i.normal,
                iI = i.shift || {}, il = i.alt || {}, io = i.shift_alt || {}, iO = i.caps || {}, iQ = i.shift_caps || {}, i_ = i.dk,
                ic = i.cbk,
                iC, ie, iv, iV, ix = null,
                iX, iz, iZ, iw, iW = -1,
                is = [];
    ...
    var n = function (i, e) {
        var iI = document.getElementById(Q + e + '_left'),
                il = document.getElementById(Q + e + '_left');
        switch (0 + i) {
            case 0:
    ...
    (function () {
        ...
        U.keyboard.innerHTML = ("<div id=\"kbDesk\"><!-- --></div>" + "<div class=\"progressbar\"><!-- --></div>" + "<select id=\"kb_langselector\"></select>" + "<select id=\"kb_mappingselector\"></select>" + '<div id="copyrights" nofocus="true"><a href="#" target="_self" title="点击进行中英文切换">中英文切换 </a></div>').replace(/(<\w+)/g, "$1 unselectable='on' ");
...
VirtualKeyboard.IME = new function () {
    var i = this;
    var I = "<div id=\"VirtualKeyboardIME\" style=\"z-index:9101;\"><table><tr><td class=\"IMEControl\"><div class=\"left\"><!-- --></div></td>" + "<td class=\"IMEControl IMEContent\"></td>" + "<td class=\"IMEControl\"><div class=\"right\"><!-- --></div></td></tr>" + "<tr><td class=\"IMEControl IMEInfo\" colspan=\"3\"><div class=\"showAll\"><div class=\"IMEPageCounter\"></div><div class=\"arrow\"></div></div></td></tr></div>";
    var l = null;
    var o = "";
    var O = 0;
    var Q = false;
    ...
    i.updatePosition = function () {
        ...
        l.style.top = x.y + X.y + X.h - c.scrollTop + 5 + 'px'
    };
